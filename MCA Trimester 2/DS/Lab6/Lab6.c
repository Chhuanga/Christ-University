                    ...
                    MCA B
                        Home
                            Calendar
                                Enrolled
                                    To -
    do 2 2024 - 2MCAB - App.Stat using R 2MCA B 2 2 MCA B_OS B 2 2MCA_B_SoftwareEngineering_2024_2025 B D DSA MCA B 2 2 MCA B_Java Programming_2024 M MCA251 - Software Project Development Lab – Phase - I 2MCA B 2 2024 - MCA - Research Methodology I I - MCA - B Web Stack Development(MCA172)
B
        H
            HED 1MCAB I
                I MCA B 1 1MCA B PYTHON PROGRAMMING 2 2024 -
    I MCA - B COD P PG - 2024 - 2025 PG Coordinator Interaction 1 1MCA B(2024) - Advance Database Technologies MCA B Archived classes Settings Assignment details Lab 6 Bhuvana Jayabalan Computer Science
• Nov 16 10 points Due Nov 18 Daer Students

    Find Lab 6 experiment

    Lab Exp 6.docx Word Class comments Your work Turned in

    lab
    - 6.c Text

      sorted_data_merge.txt Text

      sorted_data_quick.txt Text

      unsorted_data.txt Text Work cannot be turned in after the due date Private comments
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <time.h>
...
lab - 6.c Displaying sorted_data_merge.txt.